      ...
      onOk: function() {
        if (this.imageEditMode) {
          ...
          'image' == l
            ...
            : ((this.imageElement = d.document.createElement('input')), this.imageElement.setAttribute('type', 'image')),
                          ...
                          children: [
                            {
                              ...
                              commit: function(a, b) {
                                var c = this.getValue()
                                1 == a
                                  ? (c && d.activeFilter.check('img{width,height}') ? b.setStyle('width', CKEDITOR.tools.cssLength(c)) : b.removeStyle('width'),
                            ...
                            },
                            {
                              ...
                              commit: function(a, b) {
                                var c = this.getValue()
                                1 == a
                                  ? (c && d.activeFilter.check('img{width,height}') ? b.setStyle('height', CKEDITOR.tools.cssLength(c)) : b.removeStyle('height'),
                              ...
                              (b.on(
                                ...
                                function(a) {
                                  ...
                                  'true' == b.getCustomData('isReady') &&
                                    d &&
                                    ((b = b.$.height / b.$.width * d), isNaN(b) || (this.setValueOf('info', 'txtHeight', Math.round(b)), e(this)))
                                  a.data && a.data.preventDefault()
                                },
                                this.getDialog()
                              ),
                          ...
                          commit: function(a, b) {
                            ...
                            1 == a || 4 == a
                              ? (isNaN(c)
                                  ...
                                  : (b.setStyle('border-width', CKEDITOR.tools.cssLength(c)), b.setStyle('border-style', 'solid')),
                ...
                },
                {
                  ...
                  commit: function(a, b) {
                    1 == a
                      ...
                      : 4 == a ? b.setAttribute('title', this.getValue()) : 8 == a && b.removeAttribute('title')
                  }
                }
              ]
            },
